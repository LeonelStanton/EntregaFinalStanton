      ...
      <div className="flex items-center font-medium justify-around  ">
        <div className="z-50 py-1 md:w-auto w-full flex justify-between">
          <Link to="/">
            <img
              src={Logo}
              alt="logo"
              className="md:cursor-pointer h-20 md:h-16 lg:h-20 p-3"
            />
          </Link>
          <div
          ...
          {links.map((link) => (
            <div className="z-20" key={link.name}>
              <div className="px-3 text-left group">
                <h1 className="flex justify-between items-center md:pr-0  group hover:text-gray-300 ">
                  <NavLink
        ...
        >
          ...
          {links.map((link) => (
            <div className="z-20" key={link.name}>
              <div className="px-3 text-left group">
                <h1 className="py-7 flex justify-between items-center md:pr-0  group hover:text-gray-500 cursor-pointer">
                  <NavLink
                    to={`/category/${link.name}`}
                    onClick={() => setOpen(!open)}
                  >

        ...
        <div className="px-5 py-24 flex flex-col lg:flex-row">
          ...
          <div className="lg:w-3/5 w-full px-10 lg:px-0 bg-white flex flex-col md:ml-auto md:py-8 mt-8 md:mt-0">
            ...
            <p className="leading-relaxed mb-5 text-gray-600">
              Para obtener una respuesta rápida, escriba directo al Whatsapp de
              la empresa.
            </p>
            <div className="relative mb-4">
              ...
              <input
                ...
                id="name"
                name="name"
                className="w-full bg-white border border-gray-300 focus:border-neutral-700 focus:ring-2 focus:ring-neutral-50  text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
              />
            </div>
            <div className="relative mb-4">
              <label
